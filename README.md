...
I've built software across full-stack web, cloud deployment, systems programming, and developer tooling, including a fully deployed final exam scheduling web app for Northeastern University's Registrar and Python applications to improve hardware testing processes at BAE Systems.

I love combining creativity and technical skill to solve challenging problems with real impact on real people. Outside of coding, I'm usually studying Turkish, climbing, playing the cello, or tutoring students in CS, math, and test prep.

---

## 🚀 Technical Skills

- **Languages:** Python, TypeScript, JavaScript, Java, SQL, C++, C, Bash, HTML, CSS
- **Frameworks & Tools:** Git, Docker, AWS, React, Node.js, FastAPI, Express, GitHub Actions, PostgreSQL, Pytest
